...
import 'package:momobill/features/login/data/repositories/user_repository_impl.dart';
...
class AuthenticationInjection {
  static void setupServiceLocator(GetIt sl) {
    ...
    sl.registerLazySingleton<UserRepository>(() => UserRepositoryImpl(loginRemoteDataSource: sl(), networkInfo: sl()));
  }
}